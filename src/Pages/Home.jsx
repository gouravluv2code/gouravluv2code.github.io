...
const Home = () => {
	const paragraph = (
		<>
		  {"I'm a fullstack web developer building the front-end of websites and web applications that leads to the success of the overall product. Check out some of my work in the projects section."}
		  <br /><br />
		...
		<Box
		  id='home'
			...
			<About
				id='projects'
				heading='My projects'
				paragraph='Here you will find some of the clone and personal project that I created in my learning process and some of the projects that I have worked on collaboratively'
			/>
			<Projects />
			<About
				heading='GitHub stats'
				paragraph='Here you will find my GitHub stats and some of the projects that I have worked on collaboratively'
			/>
			<GitHubStats />
			<About
				heading='Contact me'
				paragraph='Feel free to Contact me by submitting the form below and I will get back to you as soon as possible'
			/>
			<Contact />
		</Box>
	);
