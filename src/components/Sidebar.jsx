...
import { FaProjectDiagram, FaHome, FaTools } from "react-icons/fa";
...
export default function Sidebar({ children }) {
	...
	return (
		<Box
			minH='100vh'
			// bg={useColorModeValue("gray.100", "#171d23")}
			css={{
...
const MobileNav = ({ onOpen, ...rest }) => {
	...
	return (
		<Flex
			bg={useColorModeValue("rgba(256,256,256,0.8)", "rgba(0,0,0,0.2)")}
			w={{ base: "92%", md: "12rem" }}
			rounded='1rem'
			pos={"fixed"}
			top='2'
			...
			<HStack spacing={{ base: "0", md: "4" }}>
				...
				<Tag
					...
					<Avatar
						...
						mr={2}
					/>
					<TagLabel color='white'>Gourav</TagLabel>
				</Tag>
			</HStack>
		</Flex>
	);
